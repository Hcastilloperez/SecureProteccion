...
export class EscortController {
  ...
  async getRoutes(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (escortId) where.escortId = String(escortId);
      if (installationId) where.installationId = String(installationId);

      const routes = await prisma.escortRoute.findMany({
        where,
        include: {
  ...
  async createRoute(req: Request, res: Response): Promise<void> {
    try {
      ...
      const route = await prisma.escortRoute.create({
        data: {
          name,
          description,
          waypoints,
  ...
  async updateRoute(req: Request, res: Response): Promise<void> {
    try {
      ...
      const route = await prisma.escortRoute.update({
        where: { id },
        data: {
          ...(name && { name }),
  ...
  async getMovements(req: Request, res: Response): Promise<void> {
    try {
      ...
      const movements = await prisma.escortMovement.findMany({
        where,
        include: {
          escort: { select: { id: true, name: true, lastName: true } },
  ...
  async createMovement(req: Request, res: Response): Promise<void> {
    try {
      ...
      const movement = await prisma.escortMovement.create({
        data: {
          date: new Date(date),
  ...
  async updateMovement(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (routeTrace !== undefined) updateData.routeTrace = routeTrace;

      const movement = await prisma.escortMovement.update({
        where: { id },
        data: updateData,
        include: {
          escort: { select: { id: true, name: true, lastName: true } },
  ...
  async getTodayMovements(req: Request, res: Response): Promise<void> {
    try {
  ...
  async getAssignments(req: Request, res: Response): Promise<void> {
    try {
      ...
      const assignments = await prisma.escortAssignment.findMany({
        where,
        include: {
          escort: { select: { id: true, name: true, lastName: true } },
          route: { select: { id: true, name: true } },
  ...
  async createAssignment(req: Request, res: Response): Promise<void> {
    try {
      ...
      const assignment = await prisma.escortAssignment.create({
        data: {
          escortId,
  ...
  async updateAssignment(req: Request, res: Response): Promise<void> {
    try {
      ...
      const assignment = await prisma.escortAssignment.update({
        where: { id },
        data: {
          ...(escortId && { escortId }),
...
export const escortController = new EscortController();