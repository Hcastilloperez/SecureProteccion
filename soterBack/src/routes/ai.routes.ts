...
router.post('/analyze', requireRole('ADMIN', 'GERENTE_SEGURIDAD', 'COORDINADOR_FISICA', 'COORDINADOR_ELECTRONICA', 'COORDINADOR_INVESTIGACIONES'), (req, res) => aiController.analyzeIncident(req, res));
router.post('/security-study', requireRole('ADMIN', 'GERENTE_SEGURIDAD', 'COORDINADOR_FISICA', 'COORDINADOR_ELECTRONICA', 'COORDINADOR_INVESTIGACIONES'), (req, res) => aiController.analyzeSecurityStudy(req, res));
...
router.post('/configurations/:id/test', requireRole('ADMIN', 'GERENTE_SEGURIDAD', 'COORDINADOR_ELECTRONICA'), (req, res) => aiController.testConfiguration(req, res));
