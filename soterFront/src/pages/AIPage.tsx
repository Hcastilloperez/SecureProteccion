...
import { AIConfigForm } from '@/components/ai';
                  ...
                  <div key={config.id} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button variant="ghost" size="icon" onClick={() => openEdit(config)} aria-label="Editar configuración">
                          <Pencil className="h-4 w-4" aria-hidden="true" />
                        </Button>
                        <Button variant="ghost" size="icon" onClick={() => handleDelete(config.id)} aria-label="Eliminar configuración">
